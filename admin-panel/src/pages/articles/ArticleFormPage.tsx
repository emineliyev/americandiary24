...
const BOOLEAN_FIELDS: { key: keyof ArticleWritePayload; label: string; hint?: string }[] = [
  ...
  { key: 'is_reference', label: 'Reference Article', hint: 'Featured in the "Referenced by" widget beside the homepage header (newest 6 shown, with a circular thumbnail).' },
